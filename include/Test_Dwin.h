...
void updateHMIState()
{
    ...
    {
        // Serial.println("update data Dwin");
        // Sensor1
    float a =  random(0,100) -0.5;
        DGUS_SendVal(ADDR_SET_1, 202);
        DGUS_SendVal(ADDR_SET_2, a*100);
        DGUS_SendVal(ADDR_SET_3, 122);
        DGUS_SendVal(ADDR_SET_4, a);
        // DGUS_SendVal(ADDR_SET_5, a);
        // DGUS_SendVal(ADDR_SET_6, a);
        // DGUS_SendVal(ADDR_SET_7, a-6);
        // DGUS_SendVal(ADDR_SET_8, a-3);
        // DGUS_SendVal(ADDR_SET_9, a-2);
        // DGUS_SendVal(ADDR_SET_10, a-1);
        // Sensor 2
